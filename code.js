...
${Object.keys(cssProperties).map((property) => {
  ...
  // dist/core/controllers/DocumentController.js
  var require_DocumentController = __commonJS({
    "dist/core/controllers/DocumentController.js"(exports) {
      "use strict";
      var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
        function adopt(value) {
          return value instanceof P ? value : new P(function(resolve) {
  ...
  // dist/core/controllers/GitController.js
  var require_GitController = __commonJS({
    "dist/core/controllers/GitController.js"(exports) {
      "use strict";
      var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
        function adopt(value) {
          return value instanceof P ? value : new P(function(resolve) {
      ...
      var GitController = class {
        ...
        static commitComponentTest(msg) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
              ...
              const testResult = yield gitService.commitComponentTest(settings, msg.commitMessage, msg.componentName, msg.testContent, msg.testFilePath || "components/{componentName}.spec.ts", msg.branchName || "feature/component-tests");
              figma.ui.postMessage({
...
${commentPrefix} ${displayName}${commentSuffix}`);
  ...
  // dist/core/controllers/ExportController.js
  var require_ExportController = __commonJS({
    "dist/core/controllers/ExportController.js"(exports) {
      "use strict";
      var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
        function adopt(value) {
          return value instanceof P ? value : new P(function(resolve) {
      ...
      var ExportController = class {
        ...
        static handleUpdateUnitSettings(msg) {
          return __awaiter(this, void 0, void 0, function* () {
        ...
        static handleValidateTailwindV4() {
          return __awaiter(this, void 0, void 0, function* () {
  ...
  // dist/core/controllers/SelectionController.js
  var require_SelectionController = __commonJS({
    "dist/core/controllers/SelectionController.js"(exports) {
      "use strict";
      var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
        function adopt(value) {
          return value instanceof P ? value : new P(function(resolve) {
      ...
      var SelectionController = class {
        ...
        static loadComponentStyles(msg) {
          return __awaiter(this, void 0, void 0, function* () {
            if (!msg.componentId) {
  ...
  // dist/core/controllers/NodeController.js
  var require_NodeController = __commonJS({
    "dist/core/controllers/NodeController.js"(exports) {
      "use strict";
      var __awaiter = exports && exports.__awaiter || function(thisArg, _arguments, P, generator) {
        function adopt(value) {
          return value instanceof P ? value : new P(function(resolve) {
      ...
      var NodeController = class {
         ...
         */
        static applyVariableToNode(node, variable, property, category) {
          return __awaiter(this, void 0, void 0, function* () {
            try {
              const propertyMap = {
                "Width": "width",
  ...
  // dist/core/router/MessageRouter.js
  var require_MessageRouter = __commonJS({
    "dist/core/router/MessageRouter.js"(exports) {
      "use strict";
      var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
        if (k2 === void 0) k2 = k;
        var desc = Object.getOwnPropertyDescriptor(m, k);
      ...
      var DocumentController_1 = require_DocumentController();
      var ExportController_1 = require_ExportController();
      var SelectionController_1 = require_SelectionController();
      var GitController_1 = require_GitController();
      var NodeController_1 = require_NodeController();
      var gitServiceFactory_1 = require_gitServiceFactory();
      var gitlabService_1 = require_gitlabService();
        ...
        static handleMessage(msg) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (msg.type) {
              // Export Controller
              case "export-css":
                yield ExportController_1.ExportController.handleExportCss(msg);
                break;
              case "get-unit-settings":
                yield ExportController_1.ExportController.handleGetUnitSettings();
                break;
              case "update-unit-settings":
                yield ExportController_1.ExportController.handleUpdateUnitSettings(msg);
                break;
              case "validate-tailwind-v4":
                yield ExportController_1.ExportController.handleValidateTailwindV4();
                break;
              // Selection Controller
              case "select-component":
                yield SelectionController_1.SelectionController.handleSelection(msg);
                break;
              case "focus-node":
                yield SelectionController_1.SelectionController.handleFocusNode(msg);
                break;
              case "load-component-styles":
                yield SelectionController_1.SelectionController.loadComponentStyles(msg);
                break;
              // Git Controller
              case "save-git-settings":
              case "save-gitlab-settings":
                yield GitController_1.GitController.saveGitSettings(msg);
                break;
              case "commit-to-repo":
              case "commit-to-gitlab":
                yield GitController_1.GitController.commitToRepo(msg);
                break;
              case "generate-test":
                yield GitController_1.GitController.generateTest(msg);
                break;
              case "commit-component-test":
                yield GitController_1.GitController.commitComponentTest(msg);
                break;
              ...
              case "list-repositories":
                try {
                  ...
                  const repositories = yield listService.listRepositories({
                    provider: msg.provider || "gitlab",
                    projectId: "",
                    token: msg.token,
                    saveToken: false,
              ...
              case "list-branches":
                try {
                  ...
                  const branches = yield githubService.listBranches({
                    provider: "github",
                    projectId: msg.projectId,
                    token: msg.token,
                    saveToken: false,
              ...
              case "refresh-data":
                try {
                  yield DocumentController_1.DocumentController.collectDocumentData();
              ...
              case "delete-variable":
                try {
                  ...
                  const refreshedData = yield DocumentController_1.DocumentController.collectDocumentData();
              ...
              case "get-existing-collections":
                try {
                  ...
                  for (const collection of existingCollections) {
                    ...
                    const variables = (yield Promise.all(variablesPromises)).filter((v) => v !== null);
              ...
              case "preview-import":
                try {
                  ...
                  const tokens = variableImportService_1.VariableImportService.parseCSS(msg.content);
                  const collections = yield figma.variables.getLocalVariableCollectionsAsync();
                  const variableIds = collections.reduce((acc, c) => acc.concat(c.variableIds), []);
                  const allVariables = (yield Promise.all(variableIds.map((id) => figma.variables.getVariableByIdAsync(id)))).filter((v) => v !== null);
                  const diff = variableImportService_1.VariableImportService.compareTokens(tokens, allVariables);
                ...
                try {
                  ...
                  for (const nodeId of nodeIds) {
                    ...
                    if (node && node.type !== "DOCUMENT" && node.type !== "PAGE") {
                      ...
                      if (yield NodeController_1.NodeController.applyVariableToNode(node, variable, property, categoryType))
                        successCount++;
                      else
                        failCount++;
                    } else
                  ...
                  if (successCount > 0)
                    figma.notify(`Applied token to ${successCount} nodes`);
                } catch (error) {
  ...
  var require_plugin = __commonJS({
    "dist/core/plugin.js"(exports) {
      ...
      var DocumentController_1 = require_DocumentController();
      var GitController_1 = require_GitController();
      var MessageRouter_1 = require_MessageRouter();
      figma.showUI(__html__, { width: 650, height: 900, themeColors: true });
      DocumentController_1.DocumentController.collectDocumentData();
      GitController_1.GitController.loadSavedGitSettings();
      ...
      figma.ui.onmessage = (msg) => __awaiter(void 0, void 0, void 0, function* () {
        try {
          yield MessageRouter_1.MessageRouter.handleMessage(msg);
        } catch (error) {
