...
export const SUCCESS_MESSAGES = {
  COMMIT_SUCCESS:
    'Design tokens successfully committed! Your CSS variables are now ready for development.',
  TEST_COMMIT_SUCCESS:
    'Component test successfully committed! The generated test is ready for your review.',
