...
function renderStats(statsData) {
  ...
  let html = `
    ...
    <div class="stats-table">
        <!-- Table Header -->
        <div style="display: grid; grid-template-columns: 1fr 60px 100px; gap: 12px; padding: 0 12px 8px 12px; border-bottom: 1px solid rgba(255,255,255,0.1); margin-bottom: 8px; align-items: center;">
  ...
  statsData.forEach((item) => {
    ...
    // Render Component Row (without expand button for instances)
    html += `
      <div class="unified-list-item component-item" data-id="${item.id}" style="display: grid; grid-template-columns: 1fr 60px 100px; gap: 12px; align-items: center; padding: 8px 12px; background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.05); border-radius: 8px;">
...
function applyTokenToSelection(issueId, property, category) {
  ...
  const occurrenceCheckboxes = document.querySelectorAll(`.occurrence-checkbox[data-issue-id="${issueId}"]:checked`);
  const nodeIds = [];
