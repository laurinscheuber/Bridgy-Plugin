...
// SecurityUtils moved to modules/utils.js



// ===== UI HELPERS =====
// UIHelper moved to modules/utils.js
...
// Repository checks moved to modules/utils.js
...
// ===== LOADING SYSTEM =====
// loadingProgress moved to modules/state.js
// loadingSteps moved to modules/constants.js
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  initSearchFeatures();
  if (window.initVariablesTab) window.initVariablesTab();
});

// ===== SEARCH FEATURES =====
// Search features moved to modules/search.js
...
// filterStats moved to modules/stats.js
...
// State variables moved to modules/state.js

// AVAILABLE_UNITS moved to modules/constants.js
...
// clearSearch moved to modules/search.js
...
// getScoreColor moved to modules/utils.js
...
// Toggle sort order
// toggleStatsSort logic moved to modules/stats.js

// Render component stats
// renderStats moved to modules/stats.js
                ...
                <div style="display: flex; flex-direction: column; gap: 8px;">
                    ${(() => {
                      const renderRow = (label, score, weight, description) => {
                        ...
                        return `
                                <div class="quality-breakdown-row" title="${description}" style="display: flex; align-items: center; justify-content: space-between; font-size: 12px; padding: 8px 10px; background: rgba(255,255,255,0.03); border-radius: 6px; cursor: help;">
                                    <div style="flex: 1;">
...
// cachedRepositories moved to modules/state.js
...
// cachedBranches moved to modules/state.js
...
// currentImportPreview moved to modules/state.js
