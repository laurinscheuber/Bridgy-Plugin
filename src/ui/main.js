...
function renderTailwindReadinessSection(validation) {
  ...
  let html = `
    ...
    <div id="${sectionId}" class="quality-section-collapsible" style="margin-bottom: 16px;">
      <div class="section-header-collapsible" onclick="toggleQualitySection('${sectionId}')" style="cursor: pointer; padding: 12px 0; display: flex; align-items: center; gap: 12px; user-select: none;">
        <span class="material-symbols-outlined section-chevron" style="font-size: 20px; color: var(--purple-light); transition: transform 0.3s ease; ${isSectionExpanded ? '' : 'transform: rotate(-90deg);'}">expand_more</span>
...
function displayComponentHygieneSection(result) {
  ...
  let html = `
    ...
    <div id="${sectionId}" class="quality-section-collapsible" style="margin-bottom: 16px;">
      <div class="section-header-collapsible" onclick="toggleQualitySection('${sectionId}')" style="cursor: pointer; padding: 12px 0; display: flex; align-items: center; gap: 12px; user-select: none;">
        <span class="material-symbols-outlined section-chevron" style="font-size: 20px; color: var(--purple-light); transition: transform 0.3s ease; ${isSectionExpanded ? '' : 'transform: rotate(-90deg);'}">expand_more</span>
        <h2 style="color: rgba(255, 255, 255, 0.9); display: flex; align-items: center; gap: 10px; font-size: 1.2rem; margin: 0; flex: 1;">
          <span class="material-symbols-outlined" style="font-size: 22px; color: var(--purple-light);">cleaning_services</span>
          Unused Components
          <span style="font-size: 14px; color: rgba(255, 255, 255, 0.6);">${result.hygieneScore}%</span>
        </h2>
      </div>
      <div class="section-content-collapsible" style="display: ${isSectionExpanded ? 'block' : 'none'};">
        <p style="color: rgba(255, 255, 255, 0.6); font-size: 12px; margin: 0 0 16px 32px;">
  ...
  result.unusedComponents.forEach((component, idx) => {
    ...
    let variantLabel = '';
    if (isComponentSet) {
      variantLabel = `<span class="list-badge" style="height: 16px; font-size: 10px; margin-left: 8px; background: rgba(139, 92, 246, 0.2); color: var(--purple-light); border: 1px solid rgba(139, 92, 246, 0.3);">${component.unusedVariantCount}/${component.totalVariants}</span>`;
    }
      ...
      componentHtml += `
        <div class="node-header" style="display: flex; align-items: center; gap: 6px;">
          <div onclick="toggleComponentHygieneGroup('${groupId}')" style="display: flex; align-items: center; flex: 1; cursor: pointer; min-width: 0;">
            <span class="material-symbols-outlined" style="font-size: 18px; margin-right: 8px; color: var(--purple-light);">inventory_2</span>
        ...
        componentHtml += `
          <div class="instance-row" style="display: flex; align-items: center; justify-content: space-between; padding: 6px 0; margin-bottom: 4px;">
            <div style="display: flex; align-items: center; gap: 6px; overflow: hidden; flex: 1;">
              <span class="material-symbols-outlined" style="font-size: 14px; opacity: 0.5;">widgets</span>
            ...
            <div style="display: flex; gap: 6px; align-items: center;">
              <button 
                ...
                style="padding: 4px; background: rgba(139, 92, 246, 0.15); border: 1px solid rgba(139, 92, 246, 0.25); border-radius: 4px; color: var(--purple-light); cursor: pointer; display: flex; align-items: center; justify-content: center;"
              >
              ...
              <button 
                ...
                style="padding: 4px; background: rgba(239, 68, 68, 0.15); border: 1px solid rgba(239, 68, 68, 0.25); border-radius: 4px; color: #ef4444; cursor: pointer; display: flex; align-items: center; justify-content: center;"
              >
      ...
      componentHtml += `
        <div style="display: flex; justify-content: space-between; align-items: center; gap: 12px;">
          <div style="flex: 1; min-width: 0; display: flex; align-items: center;">
            <span class="material-symbols-outlined" style="font-size: 18px; margin-right: 8px; color: var(--purple-light);">${isComponentSet ? 'inventory_2' : 'widgets'}</span>
            <div style="flex: 1; min-width: 0;">
              <div style="font-weight: 500; color: rgba(255, 255, 255, 0.9); font-size: 13px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
          ...
          <div style="display: flex; gap: 6px; align-items: center;">
            <button 
              ...
              style="padding: 6px; background: rgba(139, 92, 246, 0.2); border: 1px solid rgba(139, 92, 246, 0.3); border-radius: 4px; color: var(--purple-light); cursor: pointer; display: flex; align-items: center; justify-content: center;"
            >
  ...
  // Find where to insert the section (after Tailwind Readiness or at the end)
  const existingSection = document.getElementById(componentHygieneId);
  if (existingSection) {
...
function displayVariableHygieneSection(result) {
  ...
  let html = `
    ...
    <div id="${sectionId}" class="quality-section-collapsible" style="margin-bottom: 16px;">
      <div class="section-header-collapsible" onclick="toggleQualitySection('${sectionId}')" style="cursor: pointer; padding: 12px 0; display: flex; align-items: center; gap: 12px; user-select: none;">
        <span class="material-symbols-outlined section-chevron" style="font-size: 20px; color: var(--purple-light); transition: transform 0.3s ease; ${isSectionExpanded ? '' : 'transform: rotate(-90deg);'}">expand_more</span>
        <h2 style="color: rgba(255, 255, 255, 0.9); display: flex; align-items: center; gap: 10px; font-size: 1.2rem; margin: 0; flex: 1;">
          <span class="material-symbols-outlined" style="font-size: 22px; color: var(--purple-light);">database</span>
          Unused Variables
          <span style="font-size: 14px; color: rgba(255, 255, 255, 0.6);">${result.hygieneScore}%</span>
        </h2>
      </div>
  ...
  result.unusedVariables.forEach((variable, idx) => {
    const itemId = `variable-hygiene-${idx}`;
    const displayName = SecurityUtils.escapeHTML(variable.name);
    const collectionName = SecurityUtils.escapeHTML(variable.collectionName);

    let variableHtml = `
      <div id="${itemId}-card" class="quality-issue-card" style="margin-bottom: 8px; display: block; padding: 10px; background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.05); border-radius: 6px;">
        <div style="display: flex; justify-content: space-between; align-items: center; gap: 12px;">
          <div style="flex: 1; min-width: 0; display: flex; align-items: center;">
            <span class="material-symbols-outlined" style="font-size: 18px; margin-right: 8px; color: var(--purple-light);">token</span>
            <div style="flex: 1; min-width: 0;">
              <div style="font-weight: 500; color: rgba(255, 255, 255, 0.9); font-size: 13px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                ${displayName}
              </div>
              <div style="font-size: 11px; color: rgba(255, 255, 255, 0.5); margin-top: 2px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                ${collectionName}
              </div>
            </div>
          </div>
  ...
  const existingSection = document.getElementById(variableHygieneId);
  if (existingSection) {
    existingSection.remove();
  }
